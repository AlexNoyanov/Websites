...
if(isset($_POST['submit'])  )
{
    ...
    $data = mysqli_fetch_assoc($query);
       ...
       $admindata = mysqli_fetch_assoc($adminquery);
        ...
        if($admindata['user_password'] === md5(md5($_POST['password'])) ){
    ...
    {
        print "<div class='containerLogin'>Incorrect Login/Password</div> <p></p>";
    }
}
?>
...
<!--     <p>Чтобы войти на сайт пожалуйста авторизуйтесь на странице.</p> -->
    <hr>
        ...
        Do not attach my IP(less safe) <input type="checkbox" name="not_attach_ip"><br>
    <input name="submit" type="submit" class="registerbtn" value="Enter">
